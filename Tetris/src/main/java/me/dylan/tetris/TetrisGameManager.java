...
//    멀티플레이어 게임 관리 변수
    ...
    public void startGame(List<Player>onlinePlayerList, List<Player>activePlayerList, List<Player>registeredPlayerList) {
        if (isGameRunning) {
...
//        }
        ...
        game = new TetrisGame(plugin, onlinePlayerList, activePlayerList, registeredPlayerList);
//        isGameRunning = true;
