...
//            Z블록
    ...
    private static final int[][][] HOLDING_BLOCKS_1 = {
            {
//                I 블록
                    {-21, -34, -12},
                    {-20, -34, -12},
...
//            Z블록
    ...
    private static final int[][][] HOLDING_BLOCKS_2 = {
            {
//                I 블록
                    {26, -34, -12},
                    {27, -34, -12},
...
//            Z블록
    ...
    private static final int[][][] HOLDING_BLOCKS_3 = {
            {
//                I 블록
                    {73, -34, -12},
                    {74, -34, -12},
...
//            Z블록
    ...
    private static final int[][][] HOLDING_BLOCKS_4 = {
            {
//                I 블록
                    {3, 34, -15},
                    {4, 34, -15},
...
//            Z블록
    ...
    private static final int[][][] HOLDING_BLOCKS_5 = {
            {
//                I 블록
                    {49, 34, -15},
                    {50, 34, -15},
    ...
    public void drawUpcomingBlocks(int playerNumber, int[] upcomingPieces) {
        ...
        for (int i = 0; i < upcomingPieces.length; i++) {
            ...
            int[][] c = switch (playerNumber) {
                ...
                case 2 -> UPCOMING_BLOCKS_3[blockNumber];
                case 3 -> UPCOMING_BLOCKS_4[blockNumber];
                case 4 -> UPCOMING_BLOCKS_5[blockNumber];
                default -> null;
            };
...
//        그냥 블록이 떨어져서 위치할 곳에 유리블럭 생성하면 끝
    ...
    public void drawPiece() {
        ...
        int[][] coordination = getCurrentBlockCoordinates(pieceType, rotation)[playerNumber];
...
//        player.sendMessage("number: " + playerNumber);
        ...
        switch (playerNumber) {
            case 0 :
                int newRotation1 = (rotation + 1) % BLOCK_PLAYER_1[pieceType].length;
                if (!checkCollision(newRotation1, offsetY)) {
                    rotation = newRotation1;
                    drawPiece();
                    drawGhostPiece();
                    return;
                }
            ...
            case 1 :
                int newRotation2 = (rotation + 1) % BLOCK_PLAYER_2[pieceType].length;
                if (!checkCollision(newRotation2, offsetY)) {
            ...
            case 2 :
                int newRotation3 = (rotation + 1) % BLOCK_PLAYER_3[pieceType].length;
                if (!checkCollision(newRotation3, offsetY)) {
                    rotation = newRotation3;
                    drawPiece();
                    drawGhostPiece();
                    return;
                }
            ...
            case 3 :
                int newRotation4 = (rotation + 1) % BLOCK_PLAYER_4[pieceType].length;
                if (!checkCollision(newRotation4, offsetY)) {
                    rotation = newRotation4;
                    drawPiece();
                    drawGhostPiece();
                    return;
                }
            ...
            case 4 :
                int newRotation5 = (rotation + 1) % BLOCK_PLAYER_5[pieceType].length;
                if (!checkCollision(newRotation5, offsetY)) {
                    rotation = newRotation5;
                    drawPiece();
                    drawGhostPiece();
                    return;
                }
    ...
    public boolean checkCollision(int newRotation, int _offsetY) {
        ...
        int[][] currentShape = getCurrentBlockCoordinates(pieceType, newRotation)[playerNumber];
    ...
    public void drawHoldingPiece(int pieceType, int playerNumber) {
        ...
        switch (playerNumber) {
            case 0 :
                ...
                // 홀딩된 블록 표시
                int[][] cubeCoord1 = HOLDING_BLOCKS_1[pieceType];
                for (int[] coord : cubeCoord1) {
                    int x = coord[0];
                    int y = coord[1];
                    int z = coord[2];
            ...
            case 1 :
                ...
                // 홀딩된 블록 표시
                int[][] cubeCoord2 = HOLDING_BLOCKS_2[pieceType];
                for (int[] coord : cubeCoord2) {
                    int x = coord[0];
                    int y = coord[1];
                    int z = coord[2];
            ...
            case 2 :
                ...
                // 홀딩된 블록 표시
                int[][] cubeCoord3 = HOLDING_BLOCKS_3[pieceType];
                for (int[] coord : cubeCoord3) {
                    int x = coord[0];
                    int y = coord[1];
                    int z = coord[2];
            ...
            case 3 :
                ...
                // 홀딩된 블록 표시
                int[][] cubeCoord4 = HOLDING_BLOCKS_4[pieceType];
                for (int[] coord : cubeCoord4) {
                    int x = coord[0];
                    int y = coord[1];
                    int z = coord[2];
            ...
            case 4 :
                ...
                // 홀딩된 블록 표시
                int[][] cubeCoord5 = HOLDING_BLOCKS_5[pieceType];
                for (int[] coord : cubeCoord5) {
                    int x = coord[0];
                    int y = coord[1];
                    int z = coord[2];
